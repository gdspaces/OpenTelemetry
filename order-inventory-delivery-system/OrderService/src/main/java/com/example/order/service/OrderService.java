...
public class OrderService {
    ...
    private static final String INVENTORY_URL = "http://inventory-service:8082/inventory";
    private static final String DELIVERY_URL = "http://delivery-service:8083/delivery";
